...
$totalTeachers = 0; // Added
$totalCourseCreators = 0; // Added
...
// Fetch total teachers from the teachers table
$totalTeachers = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) AS total FROM instructors"))['total'];

// Fetch total course creators from the course creators table
$totalCourseCreators = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) AS total FROM course_creators"))['total'];
?>
...
<div class="container mt-5">
    ...
    <div class="row mt-4">
        ...
        <!-- Total Course Creators Card -->
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Total Course Creators</h5>
                    <p class="card-text"><?php echo $totalCourseCreators; ?></p>
                </div>
            </div>
        </div>
    </div>
